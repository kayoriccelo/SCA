...
uses
  untEntity, untBR, untEnumerator, untDMConnection, untFmList.Bomba;
...
function TFmRegBomba.GetObject: TModel;
var
...
begin
  try
    loBRBomba := TBRBomba.Create(TBomba);
